...
resource "aws_iam_role" "eks_cluster_role" {
  name = "sre-wordpress-eks-cluster-role"
...
# Custom inline policy for EKS cluster
resource "aws_iam_role_policy" "eks_cluster_inline_policy" {
  name   = "sre-wordpress-eks-cluster-inline-policy"
  role   = aws_iam_role.eks_cluster_role.name
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [
...
resource "aws_iam_role" "eks_node_group_role" {
  name = "sre-wordpress-eks-node-group-role"
